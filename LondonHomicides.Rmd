...
Iain Ager also published some of his exploratory analysis and visualisations for the period 2008 to 2018. I have used some of Iain's original code in this file and acknowledged this wherever I used his code in my Rmd. I have included the additional 2 years of data sourced from murdermap. However, Iain's original visualisations are not included in this Rmd file or in my LondonHomicides flexdashboard on github. There is however, inevitably some similarities in the look of some of the visualisations given the data we used was basically the same for the period 2008 to 2018. Iain's orginal Rmd file including his analysis and visualisations can be found here: https://www.kaggle.com/iainagar/london-homicide-victims-exploratory-data-analysis

His work was a very highly quality review of the data and provided my inspiration for going further with the analysis and the visualisation work included in my hosted flex dashboard on Github. My focus was extending Iain's work by updating the cases, providing deeper analysis of the data including data on the resolution rates and extending the richness of the data visualization.
