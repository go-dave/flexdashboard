...
* This layered point map shows the distribution of all homicides for 2008-2020 and provides colored circles based on the ethnicity of the victim and hover over data showing full details of each case based on the murder map data base.
* Homicides by victim ethnicity are generally dispersed evenly across London with a higher concentration of Black victims in Eastern boroughs.
...
## Create a cluster map showing the location of female homicide victims across 2008 to 2020 (some similar code to analysis of youth homicides in Iain Agar's original exploratory analysis but I have focused on clusters of female homicides, have used updated data and have selected a different leaflet tile map for London that provides better detail of the street locations for the female homicide clusters. I have also updated the content included in the hover over popups)
