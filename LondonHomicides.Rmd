...
Iain Ager also published some of his exploratory analysis and visualisations for the period 2008 to 2018. I have selectively used some of Iain's original code in my Rmd file and acknowledge this wherever this has occured in my Rmd. I have included the additional 2 years of data sourced from murdermap across all my analysis and visualisation. However, Iain's original visualisations are not included in this Rmd file or in my LondonHomicides flexdashboard on github. There is however, inevitably some similarities in the look of some of the visualisations given the data we used was basically the same for the period 2008 to 2018. Iain's orginal Rmd file including his analysis and visualisations can be found here: https://www.kaggle.com/iainagar/london-homicide-victims-exploratory-data-analysis.My focus was extending Iain's work by updating the cases to 2020, providing deeper analysis of the data and new approaches to understanding the data including a deep dive into homicide resolution rates and extending the richness of the data visualizations.

His work very highly quality and provided inspiration for me going further with the analysis and the visualisation work including the development of my hosted flex dashboard on Github which aims to summarise the story through interactive visualisation. 
...
## create layered point map showing locations of homicides coded by ethnicity (similar code to analysis of homicide locations by cause of death included in Iain Agar's original exploratory analysis. I have focused on location of homicides by ethnicity, have used updated data and have selected a different leaflet tile map for London that provides better detail of the street locations for the homicides. I have also updated the hover data included in the pop ups details)
